...
Machine Learning is subset of AI. ML attempts to take the data and its output to 
figure out a set of rules (a program). The goal is increase accouracy of models.
